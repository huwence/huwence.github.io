...
/******/ 	var hotCurrentHash = "566fe6b8b1a8708ff653"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ConsoleViewCtrl = __webpack_require__(194);

	var _ConsoleViewCtrl2 = _interopRequireDefault(_ConsoleViewCtrl);

	var _files = __webpack_require__(205);
	...
	function main() {
	    ...
	    if (container) {
	        var root = _fileHelpers2.default.parseFileData(_files2.default);
	        var view = new _ConsoleViewCtrl2.default(container, _init2.default, root, '/home/huwence');
	        view.update();
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FileNode = __webpack_require__(3);
	...
	exports.default = {
	  separator: '/',
	  realpath: function realpath(path, currentDir) {
	  ...
	  parseFileData: function parseFileData(data) {
	    var fileNodeHash = {};
	    var root = null;
	    data.forEach(function (item) {
	      var fileNode = new _FileNode2.default(item.id, item.name, item.type);
	      if (item.id === 0) {
	        root = fileNode;
	      }
	    ...
	    for (var nodeId in fileNodeHash) {
	      var item = fileNodeHash[nodeId];
	  ...
	  getFileByName: function getFileByName(fileNode, filename) {
	    var files = [];

	    var recursiveFind = function recursiveFind(fileNode, filename, files) {
	  ...
	  checkPath: function checkPath(fileNode, parts) {
	    var node = fileNode;
	  ...
	  parsePath: function parsePath(root, currentDir, path) {
	    ...
	    var fileNodes = this.getFileByName(root, filename);
	    var _iteratorNormalCompletion = true;
	    var _didIteratorError = false;
	    var _iteratorError = undefined;

	    try {
	      for (var _iterator = fileNodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var fileNode = _step.value;
	  ...
	  getAbsolutePath: function getAbsolutePath(fileNode) {
	    var node = fileNode;
	    var path = node.name;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileNode = function () {
	  function FileNode(id, name, type) {
	  ...
	  _createClass(FileNode, [{
	    ...
	    key: "ofChilds",
	    value: regeneratorRuntime.mark(function ofChilds() {
	      var firstChild;
	      return regeneratorRuntime.wrap(function ofChilds$(_context) {
	        while (1) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(11)(IteratorPrototype, __webpack_require__(36)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ConsoleCommandView = __webpack_require__(196);

	var _ConsoleCommandView2 = _interopRequireDefault(_ConsoleCommandView);

	var _ConsoleResultView = __webpack_require__(200);

	var _ConsoleResultView2 = _interopRequireDefault(_ConsoleResultView);

	var _CommandHandler = __webpack_require__(201);

	var _CommandHandler2 = _interopRequireDefault(_CommandHandler);

	var _Player = __webpack_require__(204);
	...
	var ConsoleViewCtrl = function () {
	  function ConsoleViewCtrl($container, data, fileRoot, initDir) {
	    _classCallCheck(this, ConsoleViewCtrl);

	    this.$container = $container;
	    this.data = data;
	    this.fileRoot = fileRoot;
	    this.currentDir = initDir;
	    this.commandHandler = new _CommandHandler2.default(this.fileRoot, this);
	    this.bindEvent();
	  }

	  _createClass(ConsoleViewCtrl, [{
	    key: 'bindEvent',
	    value: function bindEvent() {
	      var self = this;
	      _utils2.default.bindEvent(document.body, 'click', function (evt) {
	    ...
	    value: function update() {
	      ...
	      if (!_utils2.default.isArray(this.data)) {
	        return;
	      }
	      ...
	      self.data.forEach(function (item, index) {
	        ...
	        switch (type) {
	          case 'command':
	            self.commandView = new _ConsoleCommandView2.default(item, _this.commandHandler);
	            self.$container.appendChild(self.commandView.next());
	            break;
	          case 'result':
	            self.resultView = new _ConsoleResultView2.default(item);
	    ...
	    key: 'setCurrentDir',
	    value: function setCurrentDir(dir) {
	      this.currentDir = dir;
	    }
	  }, {
	    key: 'write',
	    ...
	    value: function autoplay() {
	      ...
	      var cmds = 'clear|pwd|ls|cd article|ls|cat README|cd ~/|'.split('');
	      player.start(this, cmds);
	    }
	  }]);

	  return ConsoleViewCtrl;
	}();

	exports.default = ConsoleViewCtrl;
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  pos: function pos(element, attr, val) {
	    element && attr && (element.style[attr] = val + 'px');
	  },
	  bindEvent: function bindEvent(element, evt, fn) {
	  ...
	  replaceLineBreak: function replaceLineBreak(str) {
	    return str.replace(/(?:\r\n|\r|\n)/g, '');
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TextInput = __webpack_require__(199);
	...
	var ConsoleCommandView = function () {
	  function ConsoleCommandView(commandData, commandHandler) {
	    _classCallCheck(this, ConsoleCommandView);

	    this.commandData = commandData;
	    this.commandHandler = commandHandler;
	  }

	  _createClass(ConsoleCommandView, [{
	    key: 'next',
	    value: function next() {
	      this.$line = _utils2.default.element('div');
	    ...
	    key: 'addHead',
	    value: function addHead() {
	      this.$head = _utils2.default.element('div');
	    ...
	    value: function addContent() {
	      this.$content = _utils2.default.element('div');
	      this.$text = _utils2.default.element('span');
	      this.$content.className = 'content';
	      this.$text.innerHTML = _utils2.default.replaceLineBreak(this.commandData.content);
	    ...
	    value: function addCursor() {
	      var self = this;
	      var size = _helpers2.default.measureSize(self.$content, self.commandData.content);

	      self.headWidth = self.$head.offsetWidth;
	      self.lineWidth = self.$line.offsetWidth;
	      self.lineHeight = self.$head.offsetHeight;
	      self.cursor = new _Cursor2.default(self.$content);
	      self.input = new _TextInput2.default(self.$content, function (evtType, inputValue) {
	    ...
	    value: function oninput(inputValue) {
	      this.commandData.content = _utils2.default.replaceLineBreak(inputValue);
	      var size = _helpers2.default.measureSize(this.$content, this.commandData.content);
	      var offsetX = this.headWidth + size.width;
	      var offsetY = 0;

	      if (offsetX > this.lineWidth) {
	        var row = parseInt(offsetX / this.lineWidth, 10);
	    ...
	    key: 'onenter',
	    value: function onenter(command) {
	      var cmd = _utils2.default.replaceLineBreak(command);
	      this.commandHandler.exec(cmd);
	    }
	  }, {
	    key: 'formatHead',
	    value: function formatHead(head) {
	      return 'guests@io.huwence.com:' + head + '$';
	    }
	  }]);

	  return ConsoleCommandView;
	}();

	exports.default = ConsoleCommandView;
...
/***/ function(module, exports) {
	...
	// helpers
	exports.default = {
	  measureSize: function measureSize($host, str) {
	  ...
	  fileTag: function fileTag(content, type) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cursor = function () {
	  function Cursor($container) {
	    ...
	    var $cursor = _utils2.default.element('span');
	  ...
	  _createClass(Cursor, [{
	    ...
	    value: function move(x, y) {
	      this.left = x;
	      x && _utils2.default.pos(this.$cursor, 'left', x);
	      y && _utils2.default.pos(this.$cursor, 'top', y);
	    }
	  }, {
	    key: 'flashing',
	    value: function flashing() {
	      var self = this,
	      ...
	      setTimeout(function () {
	        if (self.isBlur) {
	          ...
	          _utils2.default.addClass(self.$cursor, 'blur');
	        } else {
	          _utils2.default.removeClass(self.$cursor, 'blur');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextInput = function () {
	  function TextInput(container, cb) {
	    _classCallCheck(this, TextInput);

	    var $input = _utils2.default.element('textarea');
	  ...
	  _createClass(TextInput, [{
	    key: 'bindEvent',
	    value: function bindEvent(cb) {
	      var self = this; //webpack bug, there must be ';'

	      ['input', 'blur', 'focus'].forEach(function (evtName) {
	        _utils2.default.bindEvent(self.$input, evtName, function (evt) {
	          typeof cb === 'function' && cb(evtName, self.$input.value, evt);
	        });
	      });

	      _utils2.default.bindEvent(self.$input, 'keydown', function (evt) {
	        var key = evt.keyCode;
	        var detail = evt.detail; // simulate event
	    ...
	    key: 'move',
	    value: function move(x, y) {
	      x && _utils2.default.pos(this.$input, 'left', x);
	      y && _utils2.default.pos(this.$input, 'top', y);
	    }
	  }, {
	    key: 'focus',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConsoleResultView = function () {
	  function ConsoleResultView(resultData) {
	    _classCallCheck(this, ConsoleResultView);

	    this.resultData = resultData;
	  }

	  _createClass(ConsoleResultView, [{
	    key: 'next',
	    value: function next() {
	      var $line = _utils2.default.element('div');
	    ...
	    key: 'addContent',
	    value: function addContent() {
	      var $content = _utils2.default.element('div');
	  ...
	  return ConsoleResultView;
	}();

	exports.default = ConsoleResultView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lang = __webpack_require__(202);
	...
	var marked = __webpack_require__(203);

	// CommandHandler

	var CommandHandler = function () {
	  function CommandHandler(fileRoot, viewCtrl) {
	  ...
	  _createClass(CommandHandler, [{
	    key: 'format',
	    value: function format(type, head, content) {
	    ...
	    value: function exec(cmd) {
	      if (!cmd) {
	        ...
	        var directive = this['_' + cmds[0]];
	        if (directive) {
	          directive.apply(this, cmds.slice(1));
	        } else {
	          this.output(1, '', this.error('bash', cmds[0], _lang2.default['NoCommand']));
	    ...
	    key: 'error',
	    value: function error(cmd, path, langMsg) {
	      return cmd + ': ' + path + ': ' + langMsg;
	    }
	  }, {
	    key: 'output',
	    value: function output(type, head, content) {
	    ...
	    key: '_ls',
	    value: function _ls(path) {
	      var fileNode = _fileHelpers2.default.parsePath(this.fileRoot, this.viewCtrl.currentDir, path);
	      if (fileNode !== null) {
	        if (fileNode.isFile()) {
	          ...
	          try {
	            for (var _iterator = fileNode.ofChilds()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	              var file = _step.value;

	              if (file !== null) {
	                files += ' ' + _helpers2.default.fileTag(file.name, file.isDir() ? 'dir' : 'file');
	              }
	            }
	          } catch (err) {
	            _didIteratorError = true;
	          ...
	          this.output(1, '', this.error('ls', path, _lang2.default['NoSuchFile']));
	        }
	      } else {
	        this.output(1, '', this.error('ls', path, _lang2.default['NoSuchFile']));
	      }
	    ...
	    key: '_cd',
	    value: function _cd(path) {
	      var fileNode = _fileHelpers2.default.parsePath(this.fileRoot, this.viewCtrl.currentDir, path);
	      if (fileNode !== null) {
	        if (fileNode.isDir()) {
	          var dir = _fileHelpers2.default.getAbsolutePath(fileNode);
	          this.viewCtrl.setCurrentDir(dir);
	        } else {
	          this.output(1, '', this.error('cd', path, _lang2.default['NoDirectory']));
	        }
	      } else {
	        this.output(1, '', this.error('cd', path, _lang2.default['NoDirectory']));
	      }
	    ...
	    value: function _cat(path) {
	      ...
	      if (fileNode !== null) {
	        if (fileNode.isFile()) {
	          ...
	          var url = './articles/' + fileNode.id + '.md';
	          var content = _helpers2.default.syncGet(url);
	          self.output(1, '', marked(content));
	          self.done();
	          self.viewCtrl.pending = false;
	        } else {
	          self.output(1, '', this.error('cat', path, _lang2.default['NotSupport']));
	          self.done();
	        }
	      } else {
	        self.output(1, '', this.error('cat', path, _lang2.default['NoSuchFile']));
	        self.done();
	      }
	    }
	  }, {
...
/***/ function(module, exports) {
	...
	var Player = function () {
	    ...
	    _createClass(Player, [{
	        key: 'start',
	        value: function start(viewCtrl, cmds) {
	            var self = this;
	            if (cmds.length === 0) {
	                return;
	            }
	            ...
	            self.timer = setTimeout(function () {
	                var $textInput = viewCtrl.commandView.input.$input;
	                if (!viewCtrl.pending) {
	                    var letter = cmds.shift();
	                    if ('|' === letter) {
	        ...
	        key: 'dispatch',
	        value: function dispatch($textInput, evt) {
...
/***/ function(module, exports) {
	...
	// type = 0 is dir, type = 1 is file

	exports.default = [{ id: 0, name: '/', type: 0 }, { id: 1, name: 'home', type: 0, pid: 0 }, { id: 2, name: 'huwence', type: 0, pid: 1 }, { id: 3, name: 'article', type: 0, pid: 2 }, { id: 4, name: 'about', type: 1, pid: 2 }, { id: 5, name: 'contact', type: 1, pid: 2 }, { id: 6, name: '北京的夏', type: 1, pid: 3 }, { id: 7, name: 'opt', type: 0, pid: 0 }, { id: 8, name: 'README', type: 1, pid: 3 }, { id: 9, name: 'Docker实践', type: 1, pid: 3 }];
...
/***/ function(module, exports) {
	...
	var sysInitTip = '<p>' + new Date() + '</p>' + '<h4>Welcome to io.huwence.com space!</h4>' + '<p>Entering command to find and read my articles, you can enter `play` command in below terminal to show a simple demo. <p>' + '<p>Have fun!<p>';

	exports.default = [{ 'type': 'result', 'head': '', 'content': sysInitTip }, { 'type': 'command', 'head': '~', 'content': '' }];
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  box-sizing: border-box;\n}\nhtml,\nbody {\n  margin: 0;\n  padding: 0 3px;\n  width: 100%;\n  height: 100%;\n  background: #000;\n  color: #2fed2f;\n}\n.terminal-container {\n  padding: 0 5px;\n}\n.line {\n  font-size: 14px;\n  font-family: Monaco, Menlo, Consolas, \"Courier New\", monospace;\n  overflow-wrap: break-word;\n  clear: both;\n  line-height: 28px;\n}\n.line .head {\n  float: left;\n  padding-right: 5px;\n}\n.line .content {\n  position: relative;\n  white-space: pre;\n}\n.line .result {\n  width: 100%;\n  overflow-wrap: break-word;\n  color: #fff;\n}\n.line .result b {\n  padding-right: 10px;\n}\n.line .result .file {\n  color: #fff;\n}\n.line .result .dir {\n  color: #39beff;\n}\n.line .cursor {\n  position: absolute;\n  width: 6px;\n  top: 5px;\n  height: 18px;\n  background: #2fed2f;\n  z-index: 1;\n  opacity: 1;\n}\n.line .blur {\n  background: transparent;\n  border: 1px solid #2fed2f;\n}\n.line .input {\n  position: absolute;\n  width: 0;\n  height: 20px;\n  background: transparent;\n  opacity: 0;\n  border: none;\n  resize: none;\n}\n.line .result h1,\n.line .result h2,\n.line .result h3,\n.line .result h4,\n.line .result h5,\n.line .result h6,\n.line .result h7,\n.line .result h8 {\n  margin: 10px 0;\n}\n.line .result p {\n  margin: 0;\n}\n.line .result p code {\n  background: #fff;\n  color: #000;\n  padding: 3px;\n  border-radius: 4px;\n}\n.line .result pre {\n  white-space: pre;\n  display: inline-block;\n  border: 1px solid #ddd;\n  border-radius: 3px;\n  padding: 5px 10px;\n}\n.line .result blockquote {\n  padding: 0 10px;\n  border-left: 5px solid #ccc;\n  margin: 10px 0;\n}\n.line .result table {\n  width: 100%;\n  overflow: auto;\n  display: block;\n  border-spacing: 0;\n  border-collapse: collapse;\n}\n.line .result table tr {\n  border-top: 1px solid #ccc;\n}\n.line .result table th,\n.line .result table td {\n  border: 1px solid #ddd;\n  padding: 2px 12px;\n}\n", ""]);
